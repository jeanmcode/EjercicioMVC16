...
namespace EjercicioMVC16.Controllers
{
   ...
   [Authorize]
    public class EspeciesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Nombre,EpcFloración,EstPlantacion,TpSuelo,TmpExposicion")] Especie especie)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Nombre,EpcFloración,EstPlantacion,TpSuelo,TmpExposicion")] Especie especie)
        {
            if (ModelState.IsValid)
            {
